    ...
    try {
      ...
      if (response?.conversations && Array.isArray(response.conversations)) {
        ...
        if (response.sentimentAnalysis && setSentimentData) {
          setSentimentData({
            overallSentiment: response.sentimentAnalysis.overallLabel || 'neutral',
  ...
  const handleDeleteSession = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        const remainingConversations = conversations.filter(conv => conv.id !== selectedChat.id);
        ...
        {selectedChat || messages.length > 0 ? (
          ...
          <div className="flex-1 flex items-center justify-center bg-white">
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-2">Welcome to AI Chat</h3>
