      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Experience the future of mental healthcare with our secure,
            AI-driven platform that combines intelligent conversation, sentiment
            analysis, and blockchain-verified audit trails for complete
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            ...
            Sentinel for secure, AI-powered mental health support.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 max-w-md">
                Revolutionizing mental healthcare through AI-powered
                conversations and blockchain security. Your trusted partner in
                mental wellness.
              </p>
            </div>
            <div>
